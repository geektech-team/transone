...
export const docsStyles: StyleSheet = [
  ...
  {
    selector: '.doc-demo-toggle:hover',
    properties: { background: '#eef2f7' },
  },
  {
    selector: '.doc-demo-source',
    properties: {
      background: CODE_BG,
      color: CODE_TEXT,
  ...
  {
    selector: '.doc-demo-source code',
    properties: { fontFamily: 'inherit' },
  },
  {
